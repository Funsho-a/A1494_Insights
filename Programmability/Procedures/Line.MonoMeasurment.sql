...
GO
CREATE PROCEDURE [Line].[MonoMeasurment]
...
BEGIN
	SET NOCOUNT ON
		...
		BEGIN
			...
			[Full Date], [MonoFaceDMC],	[Monolith],	[Variant],	[Mono Average Diameter (mm)],	[Mono Diameter LSL],	[Mono Diameter USL],	[Monolith Measurement Result]
			FROM	[CTE] c			
